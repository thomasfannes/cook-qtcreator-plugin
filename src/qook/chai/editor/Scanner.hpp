#ifndef HEADER_qook_chai_editor_Scanner_hpp_ALREADY_INCLUDED
#define HEADER_qook_chai_editor_Scanner_hpp_ALREADY_INCLUDED

#include "qook/chai/editor/FormatToken.hpp"
#include <qchar.h>
